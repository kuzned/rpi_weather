import cherrypy
from WeatherDataForHTML import WeatherData
                             ...
                             <div class="card-body">
                                <div class="row">
                                    <div class="col element-box">
                                        <h5>Temperature</h5>
                                        <p>""" + str(self.currentWeather.getTemperature()) + """</p>
                                    </div>
                                    <div class="col element-box">
                                        <h5>Conditions</h5>
                                    ...
                                    <div class="col element-box">
                                        <h5>Wind Speed</h5>
                                        <p>""" + str(self.currentWeather.getWindSpeed()) + """</p>
                                    </div>
                                </div>
                            </div>
                            <div class="card-footer"><p>""" + str(self.currentWeather.getTime()) + """</p></div>
                        </div>
                    </div>
                </body>
...
if __name__=="__main__":
    currentWeather = WeatherData('Yekaterinburg')
